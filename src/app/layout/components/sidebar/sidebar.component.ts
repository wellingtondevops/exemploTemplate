...
export class SidebarComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.isArchivesSearchSimple = this.isArchiveSearchSimple();
    ...
    isArchiveSearchSimple() {
        let res = false;
        if (JSON.parse(window.localStorage.getItem('routes'))[0].archivesSearchSimple) {
            res = true;
        }
        return res;
    }
